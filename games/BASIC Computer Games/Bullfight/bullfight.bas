...
1460 GOSUB 4000: IF R < 2.4 THEN 1570
1470 GOSUB 4000: IF R < 4.9 THEN 1550
1480 GOSUB 4000: IF R < 7.4 THEN 1520
...
2020 RETURN
2030 END
3000 REM DEF FNA(K)=INT(RND(1)*2+1)
3010 R = INT(RND(1) * 2 + 1): RETURN
4000 REM DEF FNC(Q)=FND(Q)*RND(1)
4010 GOSUB 5000
4020 R = R * RND(1)
4030 RETURN
5000 REM DEF FND(Q)=(4.5+L/6-(D(1)+D(2))*2.5+4*D(4)+2*D(5)-D(3)^2/120-A)
5010 R = (4.5 + L / 6 - (D(1) + D(2)) * 2.5 + 4 * D(4) + 2 * D(5) - D(3) ^ 2 / 120 - A)
5020 RETURN
